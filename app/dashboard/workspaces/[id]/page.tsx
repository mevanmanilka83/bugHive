...
export default async function DashboardWorkspacePage({ params }: { params: Promise<{ id: string }> }) {
      ...
      <header className="flex h-14 items-center justify-between border-b px-4 lg:px-6 bg-card shrink-0 gap-4">
        <div className="flex items-center gap-2 min-w-0">
          <Button variant="ghost" size="icon" className="shrink-0" asChild>
            <Link href="/dashboard/workspaces" aria-label="Back to dashboard workspaces">
