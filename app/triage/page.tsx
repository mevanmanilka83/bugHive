...
import { TriageQueueBoard } from "@/components/features/bugs/TriageQueueBoard"
    ...
    <PublicPageLayout session={session} sidebarActive="public">
      <div className="max-w-6xl">
        <div className="rounded-lg border border-border/40 bg-card p-6 mb-6 mt-4">
          ...
          <h1 className="mb-1 text-xl font-semibold sm:text-2xl">Triage queue</h1>
          <p className="text-sm text-muted-foreground">
            Focused bug triage view for quick prioritization and follow-up.
          </p>
        </div>
