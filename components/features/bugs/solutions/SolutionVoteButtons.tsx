...
interface SolutionVoteButtonsProps {
  solutionId: string
...
export function SolutionVoteButtons({
  solutionId,
  initialUpvotes = 0,
  initialDownvotes = 0,
  ...
  }, [solutionId, userId, initialUserVote])

  const score = upvotes - downvotes

  const handleVote = async (voteType: "upvote" | "downvote") => {
    if (!userId) {
      toast.error("Please sign in to vote on solutions")
      return
    }
    ...
    return (
      <div className="flex items-center gap-1">
        <Button
          ...
          title="Upvote solution (click again to remove)"
        >
        ...
        <Button
          ...
          disabled={isVoting || !userId}
          title="Downvote solution (click again to remove)"
        >
